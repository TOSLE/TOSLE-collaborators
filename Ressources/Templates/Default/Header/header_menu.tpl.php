        ...
        <div class="content-menu-header">
            <ul>
                <?php if($this->Auth->getStatus() > 1):?>
                    <li><a href="<?php echo $this->slugs["edit_profile"];?>"><?php echo HEADER_MENU_EDITPROFILE;?></a></li>
                ...
                <?php else:?>
                    <li><a href="<?php echo $this->slugs["profilehome"];?>"><?php echo HEADER_MENU_VIEWPROFILE;?></a></li>
                <?php endif;?>
                <li class="separator"></li>
