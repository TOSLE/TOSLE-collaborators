...
CREATE TABLE IF NOT EXISTS `tosle_database`.`tosle_user` (
  ...
  `user_dateupdated` TIMESTAMP(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `tosle_database`.`tosle_conversation` (
  ...
  `conversation_tag` VARCHAR(15) NULL,
  `conversation_idowner` INT NOT NULL,
  PRIMARY KEY (`conversation_id`),
  INDEX `fk_tosle_conversation_tosle_user1_idx` (`conversation_idowner` ASC),
  CONSTRAINT `fk_tosle_conversation_tosle_user1`
    FOREIGN KEY (`conversation_idowner`)
...
CREATE TABLE IF NOT EXISTS `tosle_database`.`tosle_message` (
  ...
  `message_dateupdated` TIMESTAMP(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `message_tag` VARCHAR(25) NULL,
...
CREATE TABLE IF NOT EXISTS `tosle_database`.`tosle_stats` (
  ...
  `stats_token` VARCHAR(50) NOT NULL,
  `stats_day` INT(2) NULL,
  `stats_month` INT(2) NULL,
  `stats_year` INT(4) NULL,
  `stats_target` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `tosle_database`.`tosle_comment` (
  ...
  `comment_dateupdated` TIMESTAMP(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `tosle_database`.`tosle_statsconnection` (
  ...
  `statsconnection_day` INT(2) NULL,
  `statsconnection_month` INT(2) NULL,
  `statsconnection_year` INT(4) NULL,
  `statsconnection_date` TIMESTAMP(0) NULL DEFAULT CURRENT_TIMESTAMP,
  `statsconnection_userid` INT NOT NULL,
  PRIMARY KEY (`statsconnection_id`),
  INDEX `fk_tosle_statsconnection_tosle_user1_idx` (`statsconnection_userid` ASC),
  CONSTRAINT `fk_tosle_statsconnection_tosle_user1`
    FOREIGN KEY (`statsconnection_userid`)
    REFERENCES `tosle_database`.`tosle_user` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tosle_database`.`tosle_lessongroup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tosle_database`.`tosle_lessongroup` (
  `lessongroup_id` INT NOT NULL AUTO_INCREMENT,
  `lessongroup_lessonid` INT NOT NULL,
  `lessongroup_groupid` INT NOT NULL,
  PRIMARY KEY (`lessongroup_id`),
  INDEX `fk_tosle_lessongroup_tosle_lesson1_idx` (`lessongroup_lessonid` ASC),
  INDEX `fk_tosle_lessongroup_tosle_group1_idx` (`lessongroup_groupid` ASC),
  CONSTRAINT `fk_tosle_lessongroup_tosle_lesson1`
    FOREIGN KEY (`lessongroup_lessonid`)
    REFERENCES `tosle_database`.`tosle_lesson` (`lesson_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tosle_lessongroup_tosle_group1`
    FOREIGN KEY (`lessongroup_groupid`)
    REFERENCES `tosle_database`.`tosle_group` (`group_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
